      ...
      <div className="container">
        <section className="section">
          <div className="columns">
            <div className="column cocktail-image is-one-third-desktop">
              <img src={this.state.cocktail.image} alt={this.state.cocktail.name} className="cocktail-show-image"/>
            </div>
            <div className="column instruction-to-make is-two-thirds-desktop">
              ...
              <hr />
              <div className="columns">
                <div className="column is-one-half ingredients-col">
